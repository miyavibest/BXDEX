<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/www/wwwroot/frcw1.52codes.cn/public/../app/sdkfjf/view/system/fee.html";i:1551253228;s:62:"/www/wwwroot/frcw1.52codes.cn/app/sdkfjf/view/common/head.html";i:1546849872;s:62:"/www/wwwroot/frcw1.52codes.cn/app/sdkfjf/view/common/foot.html";i:1544153938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card-body">
    ...
    <div class="demoTable">
        <a href="<?php echo url('fee'); ?>" class="layui-btn" stfyle="float:right;margin-right:10px"><i class="fa fa-plus" aria-hidden="true"></i>刷新</a>
...
<script type="text/html" id="action">
    <a href="<?php echo url('editFee'); ?>?id={{d.id}}" class="layui-btn layui-btn-sm">编辑</a>
</script>
<script>
    ...
    var tableIn = table.render({
        ...
        cols: [
            [
                ...
                { field: 'name', align: 'center', title: '币种', width: 150 },
                { field: 'fee', title: '矿工费', width: 150, align: 'center'},
                { field: 'addressall', align: 'center', title: '平台地址ALL'},
				{ field: 'eosmemoall', align: 'center', title: 'EOS_Mmemo_ALL'},
