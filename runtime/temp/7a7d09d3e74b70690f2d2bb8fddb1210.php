<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/www/wwwroot/frcw.52codes.cn/public/../app/sdkfjf/view/suggest/index.html";i:1550977668;s:61:"/www/wwwroot/frcw.52codes.cn/app/sdkfjf/view/common/head.html";i:1546849872;s:61:"/www/wwwroot/frcw.52codes.cn/app/sdkfjf/view/common/foot.html";i:1544153938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="action">
    <a href="<?php echo url('edit'); ?>?id={{d.id}}" class="layui-btn layui-btn-sm">回复</a>
    <a class="layui-btn layui-btn-danger layui-btn-sm" lay-event="del">删除</a>
</script>
<script type="text/html" id="sst">
   {{# if(d.suggest!=''){ }}
       <a >已回复</a>
      {{# }else{ }}
      <a >未回复</a>
    ...
    var tableIn = table.render({
        ...
        cols: [
            [
                ...
                { field: 'phone', align: 'left', title: '用户手机', width: 150 },
				...
				{ width: 150, align: 'center', title: '状态', toolbar: '#sst'},
