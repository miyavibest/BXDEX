<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/frcw.52codes.cn/public/../app/index/view/wallet/tijiaoinfo.html";i:1551333764;s:62:"/www/wwwroot/frcw.52codes.cn/app/index/view/public/header.html";i:1559554411;}*/ ?>
	<!DOCTYPE html>
<html class="size">
	<head>
		<meta charset="utf-8">
		...
		<div id="app" style="background:#fff;">
			<div class="Currency1">
				...
				<div class="usericoninfo" style="border-bottom: 2px #d8d8d8 dashed;width: 90%;margin-left: 5%;">
					...
					<p><?php echo $status_arr[$tijiao['status']]; ?></p>
					<p></p>
				</div>
				...
				<div style="width: 90%;margin-left: 5%;">
					<div>
						...
						<span class="span3"><?php echo $tijiao['num']; ?></span>
					</div>
					
					<div>
						<span class="span1">发款方：</span>
						<span class="span2 span22"><?php echo $tijiao['dizhi']; ?></span>
					</div>
					
					
					<?php if(($tijiao['type'] == 'eos')): ?>
					<div>
						<span class="span1">EosMemo(发)：</span>
						<span class="span2"><?php echo $tijiao['eosmemo']; ?></span>
					</div>
					<?php endif; ?>
					...
					<div>
						...
						<span class="span2"><?php echo strtoupper($tijiao['type']); ?></span>
					</div>
					
					<div>
						<span class="span1">备注：</span>
						<span class="span2"><?php echo $tijiao['remark']; ?></span>
					</div>
					
					<div>
						<span class="span1">交易时间：</span>
						<span class="span2"><?php echo date('Y-m-d H:i:s',$tijiao['time']); ?></span>
					</div>
				</div>
