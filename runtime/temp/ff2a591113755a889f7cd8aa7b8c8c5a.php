<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/frcw.52codes.cn/public/../app/sdkfjf/view/information/lunbo_edit.html";i:1551964814;s:61:"/www/wwwroot/frcw.52codes.cn/app/sdkfjf/view/common/head.html";i:1546849872;s:61:"/www/wwwroot/frcw.52codes.cn/app/sdkfjf/view/common/foot.html";i:1544153938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane" method="post" action="" enctype="multipart/form-data">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:400px;">
                <input type="text" name="url"  value="<?php echo $list['url']; ?>" class="layui-input" lay-verify="required">
            </div>
        </div>
         <div class="layui-form-item">
            <label class="layui-form-label">中英文</label>
            <div class="layui-input-inline" style="width:400px;">
                <input type="text" name="type" value="<?php echo $list['type']; ?>"  class="layui-input" lay-verify="required">(1 中文 2英文)
            </div>
        </div>
        <!-- <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <input type="hidden" name="img" id="logo"  value="<?php echo $list['img']; ?>">
			<input type="hidden" name="id" id="logo"  value="<?php echo $list['id']; ?>">
            <div class="layui-input-block">
                <div class="layui-upload">
                    <button type="button" class="layui-btn layui-btn-primary" id="logoBtn"><i class="icon icon-upload3"></i>点击上传</button>
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" id="cltLogo" src="<?php echo $list['img']; ?>">
                        <p id="demoText"></p>
                    </div>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline" style="width:400px;">
                ...
                <a href="<?php echo url('lunbo'); ?>" class="layui-btn layui-btn-primary"><?php echo lang('back'); ?></a>
            </div>
        </div>
    </form>
</div>
...
layui.use(['form','laydate','upload'], function() {
    ...
    form.on('submit(submit)', function(data) {
        ...
        $.post("<?php echo url('lunbo_edit'); ?>", data.field, function(res) {
            layer.close(loading);
            if (res.code > 0) {
