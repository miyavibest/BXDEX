<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/www/wwwroot/frcw1.52codes.cn/public/../app/sdkfjf/view/system/frcw.html";i:1549947136;s:62:"/www/wwwroot/frcw1.52codes.cn/app/sdkfjf/view/common/head.html";i:1546849872;s:62:"/www/wwwroot/frcw1.52codes.cn/app/sdkfjf/view/common/foot.html";i:1544153938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
layui.use(['form','laydate','upload'], function() {
    ...
    form.on('submit(submit)', function(data) {
        ...
        $.post("<?php echo url('frcw'); ?>", data.field, function(res) {
            layer.close(loading);
            if (res.code > 0) {
