<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/frcw1.52codes.cn/public/../app/sdkfjf/view/login/index.html";i:1548327974;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
    <meta charset="utf-8">
        ...
        <div id="large-header" class="large-header">
            ...
            <div class="main-title">
                <div class="beg-login-box">
                    <header>
                        <h1><?php echo lang('sys_name'); ?>后台登录</h1>
                    </header>
                    <div class="beg-login-main">
                        <form class="layui-form layui-form-pane" method="post">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="captcha">
                                    <img src="<?php echo url('createVerify'); ?>" alt="captcha" onclick="this.src=this.src+'?'+'id='+Math.random()"/>
                                </div>
                            </div>
                            <div class="layui-form-item">
