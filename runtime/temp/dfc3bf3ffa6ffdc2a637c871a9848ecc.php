<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/frcw1.52codes.cn/public/../app/sdkfjf/view/system/system.html";i:1548312648;s:62:"/www/wwwroot/frcw1.52codes.cn/app/sdkfjf/view/common/head.html";i:1546849872;s:62:"/www/wwwroot/frcw1.52codes.cn/app/sdkfjf/view/common/foot.html";i:1544153938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="radio" name="open" value="0" <?php if($system['open'] == '0'): ?>checked<?php endif; ?> title="开启">
                    <input type="radio" name="open" value="1" <?php if($system['open'] == '1'): ?>checked<?php endif; ?> title="关闭">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-upload">
                    ...
                    <div class="layui-upload-list">
                        <?php if(isset($system['logo'])): ?> 
                        <img class="layui-upload-img" id="cltLogo" src="<?php echo $system['logo']; ?>">
                        <?php endif; ?>
                        <p id="demoText"></p>
                    </div>
                </div>
...
<script>
    layui.use(['form', 'layer','upload'], function () {
        ...
        if("<?php echo $system['logo']; ?>"){
            cltLogo.src = "<?php echo $system['logo']; ?>";
        }
        //普通图片上传
